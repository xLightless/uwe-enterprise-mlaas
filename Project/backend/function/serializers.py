...
class UserCreateSerializer(BaseUserCreateSerializer):
    class Meta(BaseUserCreateSerializer.Meta):
        model = User
        fields = ['id', 'username', 'password', 'is_editor']  # Ensure 'is_editor' is included
...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ['id', 'title', 'author', 'content', 'author_username', 'content_length', 'time_since_creation', 'content_summary']